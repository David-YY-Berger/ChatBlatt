    ...
    def __init__(self, api_key: str, model_name: str):
        ...
        self.agent = Agent(
            ...
            system_prompt=(
                ...
                "- Person: Extract ALL named individuals, even those mentioned incidentally or as possessives (proper nouns only). "
                ...
                "- Place: Named geographic locations — cities, regions, rivers, countries used as places."
