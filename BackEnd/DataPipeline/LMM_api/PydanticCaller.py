    ...
    def __init__(self, api_key: str, model_name: str):
        ...
        self.agent = Agent(
            ...
            system_prompt=(
                ...
                "- Person: Extract ALL named individuals, even those mentioned incidentally or as possessives (proper nouns only). Not only humans"
                ...
                "- Place: Proper noun named geographic locations — cities, regions, rivers, countries used as places."
